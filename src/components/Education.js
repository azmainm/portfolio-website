...
const Education = () => {
  return (
    <section id="education" className="flex flex-col md:flex-row items-center justify-center min-h-screen py-16 bg-gray-50 px-8 md:px-16 lg:px-32">
      {/* Animation */}
      ...
      <h1 className="text-black text-4xl font-bold font-orbitron mb-4">Education</h1>
        <div>
          <h2 className="text-2xl font-bold mb-6 text-violet-800 font-orbitron">Academic Education</h2>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-6 text-violet-800 font-orbitron">Professional Education</h2>
