...
const Colab = () => {
  ...
  return (
    <section id='colab' className="bg-gradient-to-r from-gray-700 to-cyan-700 flex flex-col md:flex-row items-center justify-center md:p-8 pb-12 min-h-1/2 space-y-2 md:space-y-0 md:space-x-8">
      {/* Left Section */}
...
>
      ...
      {/* Right Section: Form */}
      <div className="sm:p-8 md:w-1/2 border-sm border-cyan-700 px-10 py-6 bg-white shadow-lg rounded-md">
        <h2 className="text-2xl font-light mb-4 text-cyan-600 font-orbitron">Reach me out directly:</h2>
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <button
            ...
            className={`inline-flex items-center justify-center p-3 ${
              ...
              loading ? '' : 'hover:bg-cyan-700 hover:shadow-lg focus:bg-cyan-700 focus:shadow-lg active:bg-cyan-800'
