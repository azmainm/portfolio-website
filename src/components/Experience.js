  ...
  return (
    <section id="experience"  className="flex flex-col md:flex-row items-center justify-center min-h-screen py-16 bg-gray-50 px-8 md:px-16 lg:px-32 font-sans">
      ...
      <h1 className="text-black text-4xl font-bold font-orbitron mb-4">Experience</h1>
        <div>
          <h2 className="text-2xl font-bold mb-6 text-cyan-700 font-orbitron">Nagad Ltd.</h2>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-6 text-cyan-700 font-orbitron">Eve Industries LLC, USA</h2>
          <p className="text-gray-600">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-6 text-cyan-700 font-orbitron">Genetica Industries Ltd</h2>
          <p className="text-gray-600">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-6 text-cyan-700 font-orbitron">Future Track Bangladesh</h2>
          <p className="text-gray-600">
